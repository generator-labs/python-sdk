...
class Hosts(PaginationMixin):
    ...
    def update(self, host_id: str, params: Dict[str, Any]) -> Response:
    ...
    def delete(self, host_id: str) -> Response:
        """Delete a host.
    ...
    def pause(self, host_id: str) -> Response:
    ...
    def resume(self, host_id: str) -> Response:
